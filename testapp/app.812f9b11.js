...
exports.applit = undefined;

var _litHtml = require('lit-html');

var bindFactory = function bindFactory(state, view, element) {
    return function (action, bindFn) {
        return (0, _litHtml.directive)(function (part) {
            if (part.name.indexOf('on') === 0) {
                // part.element.onclick = () => {}
                part.element[part.name] = function (ev) {
                    state = action(ev)(state);
                    (0, _litHtml.render)(view(bindFn, state), element);
                };
            }
        });
    };
};
var applit = exports.applit = function applit(init, view, element) {
    if (element === void 0) {
        element = document.body;
    }
    var initState = init();
    var bindFn = bindFactory(initState, view, element);
    (0, _litHtml.render)(view(bindFn, initState), element);
};
},{"lit-html":4}],2:[function(require,module,exports) {
'use strict';
...
var incr = function incr() {
    return function (state) {
        return __assign({}, state, { count: state.count + 99 });
    };
};
var submitForm = function submitForm(ev) {
    return function (state) {
        ...
        return __assign({}, state, { form: {
                input1: __assign({}, state.form.input1, { value: ev.target.naam.value })
            } });
    };
};
var setDirty = function setDirty() {
    return function (state) {
        ...
        return __assign({}, state, { form: __assign({}, state.form, { input1: __assign({}, state.form.input1, { dirty: true }) }) });
    };
};
...
(0, _index.applit)(initialState, function (bind, state) {
    return (0, _litHtml.html)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    <h1>Counter</h1>\n    <p>", "</p>\n\n    <form onsubmit=", ">\n      <label>Naam <input name=\"naam\" type=\"text\" onkeyup=", " />\n      </label>\n    </form>\n\n    <button onclick=", ">Up</button>\n    <button onclick=", ">Down</button>\n\n    <pre>", "</pre>\n  "], ["\n    <h1>Counter</h1>\n    <p>", "</p>\n\n    <form onsubmit=", ">\n      <label>Naam <input name=\"naam\" type=\"text\" onkeyup=", " />\n      </label>\n    </form>\n\n    <button onclick=", ">Up</button>\n    <button onclick=", ">Down</button>\n\n    <pre>", "</pre>\n  "])), state.count, bind(submitForm, bind), bind(setDirty, bind), bind(up, bind), bind(down, bind), JSON.stringify(state, null, 2));
}, document.body);
var templateObject_1;
},{"../src/index":3,"lit-html":4}],5:[function(require,module,exports) {
...
//# sourceMappingURL=/app.812f9b11.map